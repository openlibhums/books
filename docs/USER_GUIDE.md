...
![" "](images/books_dashboardblock_highlight.png)
...
![The categories dashboard, listing the existing categories on the left. For the existing categories, the number of books in the category are displayed, as well as buttons to edit and delete. On the right, the form to add a new category is visible with multiple textboxes.](images/books_category_dashboard.png)
...
![" "](images/books_addbook_details.png)
...
![The page for adding new contributors and its fields.](images/books_add_contributor.png)
...
![The download, read, and buy buttons as they appear to users on the press website.](images/books_web_buttons.png)
...
![" "](images/books_final_manuscript.png)
...
![Chapter dashboard with various fields for entering metadata.](images/books_add_chapter.png)
...
![The Books metrics page.](images/books_metrics_dashboard.png)
...
![" "](images/books_format_metrics.png)
